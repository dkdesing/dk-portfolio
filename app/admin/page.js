export default function AdminGuide() {
  return (
    <main className="adminWrap">
      ...
      <div className="notice">Це безкоштовна GitHub-система редагування. Ти змінюєш файли в папці сайту, робиш Commit + Push у GitHub Desktop, і Vercel автоматично оновлює сайт.</div>
