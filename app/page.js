...
export default function Home() {
  ...
  return (
    <>
      <header className="header"><nav className="nav"><a href="/" className="logo">{site.brand}</a><div className="links"><a href="#about">Про нас</a><a href="#portfolio">Портфоліо</a><a href="#team">Команда</a><a href="#contact">Контакти</a></div><div className="actions"><a className="btn" href="/admin">Як редагувати</a><a className="btn dark" href={`tel:${site.phone}`}>{site.phone}</a></div></nav></header>
      <main>
