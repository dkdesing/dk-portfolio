...
export default function ProjectPage({ params }) {
  ...
  return (
    <>
      <header className="header"><nav className="nav"><a href="/" className="logo">{site.brand}</a><div className="actions"><a className="btn" href="/"><ArrowLeft size={16}/> Назад</a><a className="btn dark" href={`tel:${site.phone}`}>{site.phone}</a></div></nav></header>
      <main>
